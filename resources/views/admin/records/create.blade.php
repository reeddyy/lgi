    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.records.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('turnover') ? 'is-invalid' : '' }}" type="text" name="turnover" id="turnover" value="{{ old('turnover', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('employment') ? 'is-invalid' : '' }}" type="text" name="employment" id="employment" value="{{ old('employment', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('bv') ? 'is-invalid' : '' }}" type="text" name="bv" id="bv" value="{{ old('bv', '') }}">
                @if($errors->has('bv'))
                    <div class="invalid-feedback">
                        {{ $errors->first('bv') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('bs') ? 'is-invalid' : '' }}" type="text" name="bs" id="bs" value="{{ old('bs', '') }}">
                @if($errors->has('bs'))
                    <div class="invalid-feedback">
                        {{ $errors->first('bs') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('tpt') ? 'is-invalid' : '' }}" type="text" name="tpt" id="tpt" value="{{ old('tpt', '') }}">
                @if($errors->has('tpt'))
                    <div class="invalid-feedback">
                        {{ $errors->first('tpt') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('tc') ? 'is-invalid' : '' }}" type="text" name="tc" id="tc" value="{{ old('tc', '') }}">
                @if($errors->has('tc'))
                    <div class="invalid-feedback">
                        {{ $errors->first('tc') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('emp') ? 'is-invalid' : '' }}" type="text" name="emp" id="emp" value="{{ old('emp', '') }}">
                @if($errors->has('emp'))
                    <div class="invalid-feedback">
                        {{ $errors->first('emp') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('lc') ? 'is-invalid' : '' }}" type="text" name="lc" id="lc" value="{{ old('lc', '') }}">
                @if($errors->has('lc'))
                    <div class="invalid-feedback">
                        {{ $errors->first('lc') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('wh') ? 'is-invalid' : '' }}" type="text" name="wh" id="wh" value="{{ old('wh', '') }}">
                @if($errors->has('wh'))
                    <div class="invalid-feedback">
                        {{ $errors->first('wh') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('wc') ? 'is-invalid' : '' }}" type="text" name="wc" id="wc" value="{{ old('wc', '') }}">
                @if($errors->has('wc'))
                    <div class="invalid-feedback">
                        {{ $errors->first('wc') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('inv') ? 'is-invalid' : '' }}" type="text" name="inv" id="inv" value="{{ old('inv', '') }}">
                @if($errors->has('inv'))
                    <div class="invalid-feedback">
                        {{ $errors->first('inv') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('gfs') ? 'is-invalid' : '' }}" type="text" name="gfs" id="gfs" value="{{ old('gfs', '') }}">
                @if($errors->has('gfs'))
                    <div class="invalid-feedback">
                        {{ $errors->first('gfs') }}
                    </div>
